...
def result2():
    global humanity
    humanity = human2(humanity)


def replicant1(tnacilper):
    tnacilper += 1
    return tnacilper
...
def tluser():
    global replicant
    replicant = replicant1(replicant)


def replicant2(tnacilper2):
    tnacilper2 += 1
    return tnacilper2
...
def tluser2():
    global replicant
    replicant = replicant2(replicant)


def aggressive1(evisserga):
    evisserga += 1
    return evisserga
...
def response():
    global agressive
    agressive = aggressive1(agressive)


def aggressive2(evisserga2):
    evisserga2 += 1
    return evisserga2
...
def response2():
    global agressive
    agressive = aggressive2(agressive)
